...
export default function Footer() {
  return (
    <div className="w-full p-8 text-gray-700 bg-white">
      <div className="bg-gray-200 rounded-3xl p-24 flex justify-between space-x-36">
        <div id="about" className="space-y-5">
          ...
          <p>
            Yhoiki Team adalah komunitas pengembang yang berdedikasi menciptakan solusi digital kreatif
            dan inovatif. Kami memiliki pengalaman dalam membangun aplikasi modern, website interaktif,
            serta teknologi masa depan yang membantu mempercepat transformasi digital Anda.
          </p>
